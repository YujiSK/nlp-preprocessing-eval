...
## 付録C：実験A（発展）：Permutation Importance
...
![Logistic RegressionのPermutation Importance](exp_a_extra/expA_permutation_lr.png)
*図 A.1: Logistic Regressionの検証Fold上Permutation Importance*

![Linear SVCのPermutation Importance](exp_a_extra/expA_permutation_svc.png)
*図 A.2: Linear SVCの検証Fold上Permutation Importance*

![Random ForestのPermutation Importance](exp_a_extra/expA_permutation_rf.png)
*図 A.3: Random Forestの検証Fold上Permutation Importance*

![k-NNのPermutation Importance](exp_a_extra/expA_permutation_knn.png)
